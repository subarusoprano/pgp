...
enum PGPCipherAlgorithm_
{
	...
	kPGPCipherAlgorithm_Last			= kPGPCipherAlgorithm_Twofish256,
...
enum PGPHashAlgorithm_
{
	...
	//END SHA DOUBLE MOD - Imad R. Faiad
	//BEGIN TIGER192 MOD - Imad R. Faiad
	kPGPHashAlgorithm_TIGER192	= 6,
	//END TIGER192 MOD - Imad R. Faiad
	...
	kPGPHashAlgorithm_Last			= kPGPHashAlgorithm_SHA512,
	//END SHA DOUBLE MOD - Imad R. Faiad
...
enum PGPPublicKeyAlgorithm_
{
	...
	kPGPPublicKeyAlgorithm_ElGamalSE		= 0x14,
	//END ElGamal Encrypt Sign SUPPORT
	kPGPPublicKeyAlgorithm_First			= kPGPPublicKeyAlgorithm_RSA,
	
	//BEGIN ElGamal Sign SUPPORT - Imad R. Faiad
	//kPGPPublicKeyAlgorithm_Last				= kPGPPublicKeyAlgorithm_DSA,
	kPGPPublicKeyAlgorithm_Last				= kPGPPublicKeyAlgorithm_ElGamalSE,
	//END ElGamal Encrypt Sign SUPPORT
