...
/*____________________________________________________________________________
	...
	Existing algorithms have only one key size.  Values:
		...
		The following comments were added by Disastry
		kPGPCipherAlgorithm_BLOWFISH	128 / 8 = 16
		kPGPCipherAlgorithm_AES128		128 / 8 = 16
		kPGPCipherAlgorithm_AES192		192 / 8 = 24
		kPGPCipherAlgorithm_AES256		256 / 8 = 32
		kPGPCipherAlgorithm_Twofish256   256 / 8 = 32
