...
enum PGPKeyOrdering_
{
	...
	kPGPShortKeyIDOrdering              = 18,
	kPGPReverseShortKeyIDOrdering       = 19,
	//END SHORT KEYID SORT MOD
	//BEGIN TYPE SORT MOD - Disastry
	kPGPTypeOrdering                   = 20,
	kPGPReverseTypeOrdering            = 21,
	//END TYPE SORT MOD
...
//The one above is the rogue
PGPError		PGPCountAdditionalRecipientRequestsNAI( PGPKeyRef basekey,
					PGPUInt32 * numARKeys);
